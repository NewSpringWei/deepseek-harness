...
export const en = {
  ...
  startupFailed: 'Highcom Work could not start',
  startupLoading: 'Starting Highcom Work…',
  ...
  updateTitle: 'Highcom Work Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Highcom Work {version}\n\nThis release includes its matching DeepSeek Harness version. The application will restart after installation.',
  installAndRestart: 'Install and Restart',
  later: 'Later',
  updateFailedTitle: 'Update Failed',
  pluginManagerTitle: 'Desktop Plugins',
  pluginWindowTitle: 'Highcom Work — Desktop Plugins',
  ...
  aboutTitle: 'About Highcom Work',
  aboutProduct: 'Highcom Work',
  aboutMeta: 'Version {version} · Built on DeepSeek Harness under the MIT License',
  aboutRuntimeHeading: 'Version baseline',
  aboutShellVersion: 'Electron',
  aboutChromiumVersion: 'Chromium',
  aboutNodeVersion: 'Node.js in Electron',
  aboutBundledNode: 'Node.js bundled runtime',
  aboutPnpmVersion: 'pnpm bundled runtime',
  aboutDshVersion: 'DeepSeek Harness',
  aboutHostProtocol: 'Host protocol',
  aboutV8Version: 'V8',
  aboutPlatform: 'Platform',
  aboutLicenseHeading: 'License',
  aboutLicenseNote: 'Highcom Work is distributed under the MIT License.',
  aboutLicenseText: 'MIT License text',
  aboutLicenseUnavailable: 'This build does not include the license text.',
  aboutNoticesHeading: 'Third-party notices',
  aboutNoticesUnavailable: 'This build does not include third-party notices.',
...
export const zh = {
  application: '应用',
  startupFailed: 'Highcom Work 无法启动',
  startupLoading: '正在启动 Highcom Work…',
  ...
  updateTitle: 'Highcom Work 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Highcom Work {version}\n\n新版本绑定匹配的 DeepSeek Harness，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'Highcom Work — 桌面插件',
  ...
  aboutTitle: '关于 Highcom Work',
  aboutProduct: 'Highcom Work',
  aboutMeta: '版本 {version} · 基于 MIT 许可的 DeepSeek Harness 构建',
  aboutRuntimeHeading: '版本基线',
  aboutShellVersion: 'Electron',
  aboutChromiumVersion: 'Chromium',
  aboutNodeVersion: 'Node.js（Electron 内置）',
  aboutBundledNode: 'Node.js（随包运行时）',
  aboutPnpmVersion: 'pnpm（随包运行时）',
  aboutDshVersion: 'DeepSeek Harness',
  aboutHostProtocol: '宿主协议',
  aboutV8Version: 'V8',
  aboutPlatform: '运行平台',
  aboutLicenseHeading: '开源许可',
  aboutLicenseNote: 'Highcom Work 以 MIT 许可证分发。',
  aboutLicenseText: 'MIT 许可证全文',
  aboutLicenseUnavailable: '当前构建未包含许可证全文。',
  aboutNoticesHeading: '第三方声明',
  aboutNoticesUnavailable: '当前构建未包含第三方声明。',
