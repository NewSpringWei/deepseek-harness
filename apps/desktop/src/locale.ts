...
export const en = {
  ...
  aboutMenu: 'About Highcom Work',
  aboutProduct: 'Highcom Work',
  aboutLicense: 'Built on DeepSeek Harness and distributed under the MIT License.',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide Highcom Work',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit Highcom Work',
  edit: 'Edit',
  ...
  startupFailed: 'Highcom Work is unavailable',
  fatalSummary: 'The application could not start or stopped unexpectedly.',
  startupAddressInUse: 'Another Highcom Work instance (such as dsh web or the desktop app) is running. They cannot start at the same time. Quit the other running Highcom Work instance, then restart.',
  ...
  welcomeTitle: 'Highcom Work',
  welcomeBrand: 'Highcom Work',
  welcomeStart: 'Get started',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'Highcom Work',
  welcomeTaglineAfter: '',
  welcomeDescription: 'One step ahead, built for efficiency',
  ...
  welcomeKeyDescription: 'Configure official DeepSeek models to start using Highcom Work',
  ...
  updateDownloadedTitle: 'Highcom Work v{version} downloaded',
  ...
  updateDetail: 'Highcom Work {version}\n\nHighcom Work will restart to complete the update.',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 Highcom Work',
  aboutProduct: 'Highcom Work',
  aboutLicense: '基于 DeepSeek Harness 构建，依 MIT 许可证分发。',
  aboutVersion: '版本 V{version}',
  hideApplication: '隐藏 Highcom Work',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 Highcom Work',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Highcom Work 无法使用',
  fatalSummary: '应用无法启动或已意外停止。',
  startupAddressInUse: '有其他正在运行的 Highcom Work（如其他 dsh web、桌面端），无法同时启动，请退出其他正在运行的 Highcom Work 后重启。',
  ...
  welcomeKeyDescription: '配置 DeepSeek 官方模型，即可开始使用 Highcom Work',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Highcom Work v{version} 下载完成',
