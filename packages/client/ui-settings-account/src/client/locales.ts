...
export const en = {
  ...
  loading: 'Loading…', backToHarness: 'Back to Highcom Work',
  ...
  settingsSignedOutTitle: 'You are not signed in to Highcom Work',
  settingsSignedOutDescription: 'Sign in to Highcom Work to get your dedicated API Key',
...
export const zh: Record<AccountKey, string> = {
  ...
  loading: '加载中…', backToHarness: '返回 Highcom Work',
  ...
  failed: '操作未完成，请重试。',
  settingsSignedOutTitle: '当前未登录 Highcom Work 账号',
  settingsSignedOutDescription: '登录 Highcom Work 账号获取专属 API Key',
